...
{
	const int player_initial_pos = 60;
	const int enemy_initial_pos = 20;
	...
	(void)Add(new Player(player_initial_pos, player_shape));
	(void)Add(new Enemy(enemy_shape_normal, enemy_shape_on_hit, max_crying_animation_frames, enemy_initial_pos));

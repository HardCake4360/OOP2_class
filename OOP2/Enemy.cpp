...
Enemy::Enemy(const char* shape_in_normal, const char* shape_on_hit, int max_frames_crying_on_hit, const Vector2& position, const Dimension& dimension) 
	: GameObject(shape_in_normal, position.x),
...
void Enemy::process_input(int major, int minor) {
...
{
#if TODO_ENEMY_FIRE_IS_TEMPORARILY_DISABLED
